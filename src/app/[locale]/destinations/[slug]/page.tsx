        ...
        <div className="container pt-12 pb-16 md:pt-16 md:pb-24">
          ...
          <div className="bg-gradient-to-br from-ocean-50 to-seafoam-50 rounded-3xl border-2 border-ocean-100 p-8 md:p-10 mb-16 shadow-soft">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-bold text-slate-900">{t('whyVisit.title', { destination: destination.name })}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start gap-3 bg-white/80 p-5 rounded-2xl border border-seafoam-100">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-1">{t('whyVisit.authentic.title')}</h3>
                  <p className="text-sm text-slate-700 leading-relaxed">{t('whyVisit.authentic.description')}</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/80 p-5 rounded-2xl border border-seafoam-100">
                <CheckCircle className="w-5 h-5 text-seafoam-600 flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-bold text-slate-900 mb-1">{t('whyVisit.waters.title')}</h3>
                  <p className="text-sm text-slate-700 leading-relaxed">{t('whyVisit.waters.description')}</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/80 p-5 rounded-2xl border border-seafoam-100">
                <CheckCircle className="w-5 h-5 text-seafoam-600 flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-bold text-slate-900 mb-1">{t('whyVisit.history.title')}</h3>
                  <p className="text-sm text-slate-700 leading-relaxed">{t('whyVisit.history.description')}</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/80 p-5 rounded-2xl border border-seafoam-100">
                <CheckCircle className="w-5 h-5 text-seafoam-600 flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-bold text-slate-900 mb-1">{t('whyVisit.value.title')}</h3>
                  <p className="text-sm text-slate-700 leading-relaxed">{t('whyVisit.value.description')}</p>
                </div>
              </div>
            </div>
          </div>
